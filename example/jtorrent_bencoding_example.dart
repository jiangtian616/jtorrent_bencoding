...
void main() {
  ...
  var result2 = bDecode(Utf8Codec().encoder.convert('8:JTorrent')); // 'JTorrent'.codeUnits
  var result3 = bDecode(Utf8Codec().encoder.convert('l8:JTorrenti666ee')); //  ['JTorrent'.codeUnits, 666]
  var result4 = bDecode(Utf8Codec().encoder.convert('li666ed4:name8:JTorrentee')); // [666, {'name':'JTorrent'.codeUnits}
}
